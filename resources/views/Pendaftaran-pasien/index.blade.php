...
@section('judul', 'Pendaftaran Pasien')
@section('isi')
<main role="main" class="main-content">
    <div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <div class="col">
                <h2 class="h5 page-title">Pendaftaran Pasien</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-auto">
      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body">
            <a href="/pendaftaran/form"  class="btn mb-4 btn-outline-info">Tambah Data</a>
            <form action="/pendaftaran" class="form-inline" method="GET">
                ...
                <tr>
                  ...
                  <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      ...
                      <a class="dropdown-item" href="/pendaftaran/edit/{{$pasn->id}}">Edit</a>
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-body text-center justify-content-between">
                        ...
                        <p>{{$pasn->nm_pas}}</p>
                        <form action="/pendaftaran/{{$pasn->id}}" method="POST" class="form-inline justify-content-center">
                          @method('DELETE')
                          @csrf
