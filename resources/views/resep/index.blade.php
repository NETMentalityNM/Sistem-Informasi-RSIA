...
<main role="main" class="main-content">
    <div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <div class="col">
                <h2 class="h5 page-title">Data Resep</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-auto">
      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body">
            <a href="/resep/form" class="btn mb-3 btn-outline-info">Tambah Data</a>
            <!-- table -->
                ...
                <tr>
                  ...
                  <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      <a class="dropdown-item" href="/resep/edit/{{$rsep->id}}">Edit</a>
                      <button type="button" class="dropdown-item" data-toggle="modal" data-target="#modal-full{{$rsep->id}}" href="">Remove</button>                    </div>
                  </td>
                </tr>

                <div class="modal fade modal-full" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-full{{$rsep->id}}">
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-body text-center justify-content-between">
                        ...
                        <p> Anda Yakin menghapus Data resep </p>
                        <p>{{$rsep->no_resep}}</p>
                        <form action="/resep/{{$rsep->id}}" method="POST" class="form-inline justify-content-center">
                          @method('DELETE')
                          @csrf
