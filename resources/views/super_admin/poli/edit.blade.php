              ...
              <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="ID_POLI" value="{{$poli->id_poli}}" name="example-email" class="form-control" placeholder="Masukkan No. Rekam Medik" required>
                    </div>
                </div> <!-- /.col -->
                <div class="col-md-6">
                  <div class="form-group mb-3">
                    <label for="example-palaceholder">Nama Poli</label>
                    <input type="text" name="NM_POLI" value="{{$poli->nm_poli}}" class="form-control" placeholder="Diagnosa pasien" required>
                  </div>
                </div>
              </div>
