...
<main role="main" class="main-content">
    <div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <div class="col">
                <h2 class="h5 page-title">Data Jabatan</h2>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            ...
            <table class="table datatables" id="dataTable-1">
              ...
              <tbody>
                ...
                <div class="modal fade modal-full" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-full{{$jbt->id}}">
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-body text-center justify-content-between">
                        ...
                        <p> Anda Yakin menghapus Data Jabatan </p>
                        <p>{{$jbt->posisi_jabatan}}</p>
                        <form action="/jabatan/{{$jbt->id}}" method="POST" class="form-inline justify-content-center">
                          @method('DELETE')
                          @csrf
