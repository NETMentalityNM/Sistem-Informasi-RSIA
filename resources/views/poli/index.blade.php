    ...
    <div class="col-auto">
      ...
      <div class="col-md-12">
        <div class="card shadow">
          <div class="card-body">
            <a href="/poli/form" class="btn mb-3 btn-outline-info">Tambah Data</a>
            <!-- table -->
                ...
                <tr>
                  ...
                  <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      <a class="dropdown-item" href="/poli/edit/{{$pl->id}}">Edit</a>
                      <button type="button" class="dropdown-item" data-toggle="modal" data-target="#modal-full{{$pl->id}}" href="">Remove</button>
                    </div>
                  </td>
                </tr>

                <div class="modal fade modal-full" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-full{{$pl->id}}">
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-body text-center justify-content-between">
                        ...
                        <p>{{$pl->nm_pas}}</p>
                        <form action="/poli/{{$pl->id}}" method="POST" class="form-inline justify-content-center">
                          @method('DELETE')
                          @csrf
