              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group mb-3">
                    ...
                    <input type="text" name="NIP" value="{{$pegawai->nip}}" class="form-control" placeholder="Masukkan Nomor Induk Pegawai" required>
                  </div>
                  <div class="form-group mb-3">
                    <label for="example-email">Nama Pegawai</label>
                    <input type="text" name="NM_PEGAWAI" value="{{$pegawai->nm_pegawai}}" name="example-email" class="form-control" placeholder="Masukkan Nama Pegawai" required>
                  </div>
                  <div class="form-group mb-3">
                    <label for="example-password">Umur Pegawai</label>
                    <input type="number" name="UMUR_PEGAWAI" value="{{$pegawai->umur_pegawai}}" class="form-control" placeholder="Masukkan Umur Pegawai" required>
                  </div>
                </div> <!-- /.col -->
                <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label for="example-palaceholder">Alamat Pasien</label>
                      <input type="text" name="ALAMAT_PEGAWAI" value="{{$pegawai->alamat_pegawai}}" class="form-control" placeholder=" Masukkan Alamat Pegawai" required>
                    </div>
                  <div class="form-group mb-3">
                    <label for="example-helping">Nomor Hp Pegawai</label>
                    <input type="text" name="HP_PEGAWAI" value="{{$pegawai->hp_pegawai}}" class="form-control" placeholder="Masukkan Nomor Hp Pegawai" required>
                  </div>
                  <div class="form-group mb-3">
