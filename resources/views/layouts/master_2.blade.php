...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{asset('/woox/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="{{asset('woox/assets/css/fontawesome.css')}}">
    <link rel="stylesheet" href="{{asset('woox/assets/css/templatemo-woox-travel.css')}}">
    <link rel="stylesheet" href="{{asset('woox/assets/css/owl.css')}}">
    <link rel="stylesheet" href="{{asset('woox/assets/css/animate.css')}}">
...
<body>
  ...
  <script src="{{asset('woox/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{asset('/woox/vendor/bootstrap/js/bootstrap.min.js')}}"></script>

  <script src="{{asset('/woox/assets/js/isotope.min.js')}}"></script>
  <script src="{{asset('/woox/assets/js/owl-carousel.js')}}"></script>
  <script src="{{asset('/woox/assets/js/wow.js')}}"></script>
  <script src="{{asset('/woox/assets/js/tabs.js')}}"></script>
  <script src="{{asset('/woox/assets/js/popup.js')}}"></script>
  <script src="{{asset('/woox/assets/js/custom.js')}}"></script>
