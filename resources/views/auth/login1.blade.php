          ...
          <div class="w-50 mx-auto">
            <form class="mx-auto text-center" method="POST" action="{{route('login')}}">
              ...
              <div class="form-group">
                ...
                <input type="password" id="inputPassword" name="password" class="form-control form-control-lg @error('password') is-invalid @enderror" placeholder="Password" required="" required autocomplete="current-password">
              ...
              <div class="checkbox mb-3">
                <label for="remember">
                  <input type="checkbox" name="remember" id="remember" value="remember-me" {{ old('remember') ? 'checked' : '' }}> Ingat Saya </label>
              </div>
              <button class="btn btn-lg btn-primary btn-block" type="submit">Masuk</button>
              <a href="{{route('register')}}" class="btn btn-lg btn-info btn-block" type="">Daftar</a>
            </form>
          </div> <!-- .card -->
        </div> <!-- ./col -->
      </div> <!-- .row -->
